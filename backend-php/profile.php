<?php
  ...
  // Produtos que o usuário adicionou
  $userProducts = $productsDao->getProductsByUserId($id);
  ...
  <div id="main-container" class="container-fluid">
    <div class="col-md-8 offset-md-2">
      <div class="row profile-container">
        ...
        <div class="col-md-12 added-products-container">
          <h3>Produtos que enviou:</h3>
          <div class="products-container">
            <?php foreach($userProducts as $product): ?>
              <?php require("templates/products_card.php"); ?>
            <?php endforeach; ?>
            <?php if(count($userProducts) === 0): ?>
              <p class="empty-list">O usuário ainda não enviou produtos.</p>
            <?php endif; ?>
          </div>
        </div>
      </div>
